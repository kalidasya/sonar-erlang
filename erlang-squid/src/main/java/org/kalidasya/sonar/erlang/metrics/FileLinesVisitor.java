 ...
 */
public class FileLinesVisitor extends SquidAstVisitor<ErlangGrammar> implements AstAndTokenVisitor {
  ...
  public void leaveFile(AstNode astNode) {
    ...
    int fileLength = getContext().peekSourceCode().getInt(ErlangMetric.LINES);
